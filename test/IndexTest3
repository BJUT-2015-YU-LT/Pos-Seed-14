...
//TODO: Test goes here...
        ...
        try {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new FileInputStream("3.txt"),"GBK"));
            ...
            {
                System.out.println(index.getName() + "," +  index.getUnit() + "," + (float) index.getPrice() + "," +index.getDiscount());
            }
